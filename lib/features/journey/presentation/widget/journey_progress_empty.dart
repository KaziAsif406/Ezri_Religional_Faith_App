...
import 'package:template_flutter/features/journey/presentation/widget/journey_progress_card.dart';
  ...
  Widget build(BuildContext context) {
    if (_isSummaryVisible) {
      ...
      AnimatedScale(
        ...
        child: const JourneyProgressCard(),
      );
    }
      ...
      child: Column(
        ...
        children: [
          ...
          CustomButton(
            ...
            onPressed: () {
              widget.onAddJourneyPressed?.call();
              setState(() {
